 ...
 * @author <a href='mailto:bdbvse@rit.edu'>Landon Heatly</a>
...
public class WebServer {
  ...
  // TODO: REPLACE WITH /game/make
  public static final String MAKE_GAME_URL = "/make";
  public static final String DELETE_GAME_URL = "/resignGame";
  public static final String SIGNIN_URL = "/signin";
  public static final String SIGNOUT_URL = "/signout";
  public static final String VALIDATEMOVE_URL = "/validateMove";
  public static final String SUBMIT_TURN_URL = "/submitTurn";
  public static final String CHECK_TURN_URL = "/checkTurn";
  public static final String SPEC_CHECK_TURN_URL = "/spectator/checkTurn";
  public static final String SPEC_STOP_WATCHING_URL = "/spectator/stopWatching";
  public static final String BACKUP_MOVE_URL = "/backupMove";
  public static final String POST_CHAT = "/chat";
   ...
   */
  public WebServer(final TemplateEngine templateEngine, final Gson gson, final PlayerService playerService, final GameService gameService) {
    // validation
  ...
  public void initialize() {
    ...
    get(HOME_URL, new GetHomeRoute(templateEngine, playerService, gameService));

    get(SIGNIN_URL, new GetSigninRoute(templateEngine));
    post(SIGNIN_URL, new PostSigninRoute(templateEngine, playerService));
    // get(MAKEGAME_URL, new GetMakeGameRoute(templateEngine));
    // post(MAKEGAME_URL, new PostMakeGameRoute(templateEngine, gameService, playerService));

    post(SIGNOUT_URL, new PostSignoutRoute(playerService));

    // Shows the Checkers game page.
    get(GAME_URL, new GetGameRoute(templateEngine, playerService, gameService));
    post(MAKE_GAME_URL, new PostGameRoute(templateEngine, gameService));
    post(DELETE_GAME_URL, new PostResignGame(gameService, gson));

    //Checks if a move is valid
    post(VALIDATEMOVE_URL, new PostValidateMove(gameService, gson));

    post(SUBMIT_TURN_URL, new PostSubmitTurnRoute(gameService, gson));
    post(CHECK_TURN_URL, new PostCheckTurnRoute(gameService, gson));
    post(SPEC_CHECK_TURN_URL, new PostSpectatorCheckTurnRoute(gameService, gson));
    post(BACKUP_MOVE_URL, new PostBackupMoveRoute(gameService, gson));
    post(POST_CHAT, new PostChat(templateEngine, gameService));
    get(SPEC_STOP_WATCHING_URL, new GetSpectatorStopWatching());
